import { bigintToNumber } from '../utils/utility.js';
import {
    DataSnapshot,
    DataSource,
    DataSourceInfo,
...
export type Uni3Snaphot = DataSnapshot<Uni3PoolSnapshot>;
  ...
  export class Uni3ArbitrumDataSource implements DataSource<Uni3Snaphot> {
    ...
    constructor(public info: DataSourceInfo) {
      ...
      const url = 'https://data.staging.arkiver.net/uracalidev/univ3-ohlc/graphql';
    ...
    public static create(info: DataSourceInfo) {
      return new Uni3ArbitrumDataSource(info);
    }
